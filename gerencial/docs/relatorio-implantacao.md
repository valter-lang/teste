...
| D-10 | Chamados Linear/OPIVA | 250 dos 396 chamados exportados vêm do Linear (desenvolvimento) | Entram na contagem e nos painéis, identificados pela origem; entram no SLA e MTTR apenas se tiverem marcação de SLA | Decidir se desenvolvimento entra no SLA do catálogo |
